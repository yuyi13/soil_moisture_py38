...
for j in ['TCMerged']:  # 'smap', 'awra', 'cci',
    print(j)
    group = []
    for k in ['CosmOz', 'OzFlux', 'OzNet']:
        if k == 'Boorowa':
            ...
            print('CosmOz')
            file_path = 'E:/Userdata/yuy/downloads/wetness_v3/insitu/CosmOz_comparison/'
            for i in [2,3,6,7,8,9,10,11,12,15,18,19,21]:
            ...
            print('OzFlux')
            file_path = 'E:/Userdata/yuy/downloads/wetness_v3/insitu/OzFlux_comparison/'
            ...
            print('OzNet')
            file_path = 'E:/Userdata/yuy/downloads/wetness_v3/insitu/OzNet_comparison/'
            for i in ['K6', 'K7', 'K10', 'K11', 'K12', 'K14', 'Y1', 'Y4', 'Y5', 'Y6', 'Y7', 'Y8', 'Y9', 'Y10', 'Y11',
                      'Y12', 'Y13', 'YA1', 'YA3', 'YA4a', 'YA4b', 'YA4c', 'YA4d', 'YA4e', 'YA5', 'YA7a', 'YA7b', 'YA7d',
                      'YA7e', 'YA9', 'YB1', 'YB3', 'YB5a', 'YB5b', 'YB7a', 'YB7c', 'YB7d', 'YB7e']: # 'YB5e'
                df = pd.read_csv((file_path + str(i) + '.csv'), usecols=['insitu', str(j)])
                df = df.replace(-9999, np.NaN)
                df = df.dropna()
                insitu = df['insitu']
